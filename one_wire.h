...
void 	DIRECT_MODE_INPUT(void); // 	{GPIO_Init(ONEWIRE_GPIO, ONEWIRE_PIN, GPIO_MODE_IN_FL_NO_IT);}
void 	DIRECT_MODE_OUTPUT(void); //	{GPIO_Init(ONEWIRE_GPIO, ONEWIRE_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);}
void 	DIRECT_WRITE_LOW(void); //		{GPIO_WriteLow(ONEWIRE_GPIO, ONEWIRE_PIN);}
void 	DIRECT_WRITE_HIGH(void); //		{GPIO_WriteHigh(ONEWIRE_GPIO, ONEWIRE_PIN);}
